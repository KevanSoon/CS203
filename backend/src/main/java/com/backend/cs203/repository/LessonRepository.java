...
public interface LessonRepository extends JpaRepository<Lesson, Integer> {
    ...
    String SUMMARY = "SELECT l.title AS title, l.description AS description, u.username AS createdBy, l.created_at AS createdAt, GROUP_CONCAT(lt.tag_name ORDER BY lt.tag_name SEPARATOR ',') AS tags, l.lesson_picture_url AS lessonPictureUrl ";
