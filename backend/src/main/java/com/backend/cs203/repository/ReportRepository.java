...
public interface ReportRepository extends JpaRepository<Report, Integer> {
    String SUMMARY = " SELECT r.id AS id, r.title AS title, r.description AS description,r.status AS status, r.type AS type,u.username AS reportedBy,l.title AS lessonTitle,c.title AS chapterTitle,r.created_at AS createdAt,r.updated_at AS updatedAt ";
