...
class UserControllerTest {
    ...
    void getProfile_authenticated_returns200() throws Exception {
        UserResponse response = new UserResponse("testuser", "test@example.com", null, 0, null, 0L);
    ...
    void updateProfile_authenticated_returns200() throws Exception {
        UserResponse response = new UserResponse("testuser", "new@example.com", null, 0, null, 0L);
