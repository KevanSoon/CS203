...
export default function UpdateProfile() {
  ...
  return (
    <div className="min-h-screen bg-[#FCFBF7]">
      {/* ========== ADD THIS: Simple Header Bar ========== */}
      <div className="px-4 sm:px-6 lg:px-8 py-4 bg-white/80 backdrop-blur-sm border-b border-stone-100 sticky top-0 z-[100]">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          {/* Logo */}
          <Link href="/" className="text-xl font-bold text-[#9D94EB] hover:text-[#7f75d4] transition-colors">
            Simi Slang
          </Link>
          ...
          <ProfileDropdown
            ...
            profileImageUrl={form.profilePic}
