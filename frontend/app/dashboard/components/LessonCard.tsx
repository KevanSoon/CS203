...
export default function LessonCard({
  ...
  return (
    <>
      ...
      >
        <div className="relative overflow-hidden">
          <Image
            ...
            width={800}
            height={500}
            className="w-full object-cover h-44 sm:h-52 transition-transform duration-500 md:group-hover:scale-105"
          />
          ...
          <div className="space-y-2 mt-auto">
            ...
            <div className="space-y-2">
                  ...
                  ratingData.ratingCount === 0 ? (
                    ...
                    <span className="flex items-center gap-1.5 flex-wrap">
                      ...
                      <span className="text-xs text-muted-foreground">
                        ({ratingData.ratingCount} reviews)
                      </span>
                    </span>
                  )
                ) : (
              ...
              <button
                ...
                className="inline-flex items-center gap-2 text-xs sm:text-sm text-primary font-semibold hover:underline cursor-pointer"
              >
      ...
      {showDescModal && (
        ...
        >
          <div
            ...
            className="bg-card w-full sm:max-w-md rounded-t-2xl sm:rounded-2xl p-5 sm:p-6 shadow-xl relative"
          >
            <button
              onClick={closeDescModal}
      ...
      {showReviewsModal && (
        <ViewReviewsModal lessonId={lessonId} onClose={closeReviewsModal} />
      )}
    </>
  );
}
